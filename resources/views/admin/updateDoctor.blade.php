    ...
    <div class="content-wrapper">
      ...
      <div class="row">
        ...
        @endif
              ...
              <form class="forms-sample" action="{{ url('/update/{$id}', $doctor->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group row">
                  <label for="exampleInputUsername2" class="col-sm-3 col-form-label" >Doctor Name</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="exampleInputUsername2" placeholder="Doctor Name" value="{{$data->name}}" name="doctor">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="exampleInputEmail2" class="col-sm-3 col-form-label" ">Phone</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="exampleInputEmail2" placeholder="Phone" value="{{$data->phone}} name="number">
                  </div>
                </div>
                <div class="form-group">
                    <label for="exampleFormControlSelect2">Speciality</label>
                    <select class="form-control" id="exampleFormControlSelect2" name="speciality">
                  ...
                  <div class="form-group row">
                    <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Room Number</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="exampleInputEmail2" placeholder="room" name="room" value="{{$data->room}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Doctor Image</label>
                    <div class="col-sm-9">
                      <input type="file" class="form-control" id="exampleInputEmail2" placeholder="image" name="file">
                    </div>
                  </div>


                <button type="submit" class="btn btn-primary mr-10 col-12 pad ">Submit</button>
              </form>
            </div>
          </div>
        </div>
